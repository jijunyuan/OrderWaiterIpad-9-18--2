...
//    }
    active.frame=CGRectMake([UIScreen mainScreen].bounds.size.height/2-60, [UIScreen mainScreen].bounds.size.width/2-60, 120, 120);
    active.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhiteLarge;
    active.backgroundColor = [UIColor blackColor];
  // active.center=CGPointMake([UIScreen mainScreen].bounds.size.width/2, [UIScreen mainScreen].bounds.size.height/2);
    active.alpha = 0.5;
